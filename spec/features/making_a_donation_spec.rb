...
describe 'Making a donation to a family' do
  it 'makes the donation if the family data & user data is valid', :js do
    VCR.use_cassette('successful donation') do
  ...
  it "respects a donor's privacy settings", :js do
    VCR.use_cassette('anonymous donation') do
      family = create(:family)
      visit family_path(family)
      expect(page).to have_text('John Doe')
      click_link('Give to this Adoption')
  ...
  it 'lets the user put a custom donation amount & a custom at tip', :js do
    VCR.use_cassette('custom donation') do
      family = create(:family)
      visit family_path(family)
      expect(page).to have_text('John Doe')
      click_link('Give to this Adoption')
  ...
  it 'lets the user cancel their monthly donation', :js do
    VCR.use_cassette('monthly donation') do
      family = create(:family)
      visit family_path(family)
      expect(page).to have_text('John Doe')
      click_link('Give to this Adoption')
